          ...
          <nav className='flex justify-between items-center px-10 max-w-7xl mx-auto duration-500 max-md:px-2 max-lg:px-4'>
            ...
            <ul className='navlinks flex items-start gap-7'>
              <li className='navbar-links'>
                ...
                <div className='icon-close-menu text-slate-950 text-xl cursor-pointer hidden max-[780px]:block max-[780px]:absolute max-[780px]:top-[1.57rem] max-[780px]:right-[1rem]'>
                  <HugeiconsIcon icon={Cancel01Icon} onClick={closeNavbar} />
                </div>
              </ul>
            </div>
            <div className='icon-open-menu text-slate-950 cursor-pointer hidden max-[780px]:block'>
